...
<div class="container">
	<div class="register">
		<form action="../controller/transportadora/cadastrarTransportadora.php" method="POST">
			<h1>Criar Transportadora</h1><br>
            <hr class="my-4" style="padding-bottom: 50px;">
            <div class="row justify-content-center">
                <div class="col-md-12 register-top-grid">
                    <h3>Dados da Transportadora</h3><br>
                </div>
                <div class="col-md-6 register-top-grid">
                    <div>
                        <span>CNPJ</span>
                        <input type="text" name="cnpjTransportadora"  required> 
                    </div>
                    <div>
                        <span>nome</span>
                    <input type="text" name="nome" placeholder="Digite o nome da transportadora." required> 
                    </div>
                </div>
