			...
			<div class="contact-form">
				...
				<div class="col-md-8 contact-grid">
					<form>	
						...
						<input type="text" value="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Email';}">
				...
				<div class="col-md-4 contact-in">
						...
						<h4>Comunicação</h4>
							<p>Tel:353XXX-XXXX</p>
							<p>Email:<a href="mailto:contact@example.com"> pevstore@ecommerce.com</a></p>
						</div>
