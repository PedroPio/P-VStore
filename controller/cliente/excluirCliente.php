		...
		<div class="head-top">
			...
			<div class="row justify-content-center" style="padding-bottom: 50px;">
				...
				<?php
					...
					echo '<form action="confirmarExclusaoCliente.php" method="POST">';
					echo 	'<div class="col-md-6 register-top-grid">';
					echo 		'<div>';
					echo 			'<span>Nome Completo</span>';
					echo 			'<input type="text" name="nome" value="'.$view['nome'].'" disabled>';
					echo 		'</div>';
					echo 		'<div>';
					echo 			'<span>Data de Nascimento</span>';
					echo 			'<input type="text" name="nascimento" value="'.$view['dataNascimento'].'" disabled>';
					echo 		'</div>';
					echo 		'<div>';
					echo 			'<span>CPF</span>';
					echo 			'<input type="text" name="cpf" value="'.$view['cpf'].'" disabled>';
					echo 		'</div>';
					echo 		'<div>';
					echo 			'<span>Email</span>';
					echo 			'<input type="text" name="email" value="'.$view['email'].'" disabled>';
					echo 		'</div>';
					echo 		'<div>';
					echo 			'<span>Senha</span>';
					echo 			'<input type="text" name="senha" value="'.$view['senha'].'" disabled>';
					echo 		'</div>';
					echo 	'</div>';
